...
public class FindAction extends AppCompatActivity implements TextView.OnEditorActionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IngredientsConnector ingredientsConnector = new IngredientsConnector(this, ingredients);
    ...
    public void searchForRecipes(View view) {
        new FindRecepieRequest(getApplicationContext()).execute(new FindRecipeApi(ingredients,5,60));
    }
